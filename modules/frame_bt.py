...
label_image1 = ctk.CTkLabel(master = m_app.app, text = "1", font= label_font, text_color= "black")
label_display1 = ctk.CTkLabel(master = m_app.app, text = list_songs[0], font= label_font, text_color= "black")

def ls1():
    label_display1.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[0]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[0]))

label_display2 = ctk.CTkLabel(master = m_app.app, text = list_songs[1], font= label_font, text_color= "black")
def ls2():
    label_display2.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[1]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[2]))

label_display3 = ctk.CTkLabel(master = m_app.app, text = list_songs[2], font= label_font, text_color= "black")
def ls3():
    label_display3.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[2]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[4]))
    

label_display4 = ctk.CTkLabel(master = m_app.app, text = list_songs[3], font= label_font, text_color= "black")
def ls4():
    label_display4.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[3]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[3]))

label_display5 = ctk.CTkLabel(master = m_app.app, text = list_songs[4], font= label_font, text_color= "black")
def ls5():
    label_display5.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[4]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[5]))
    

label_display6 = ctk.CTkLabel(master = m_app.app, text = list_songs[5], font= label_font, text_color= "black")
def ls6():
    label_display6.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display7.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[5]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
    mixer.music.load(m_path.find_path_to_file(list_songs_name[6]))

label_display7 = ctk.CTkLabel(master = m_app.app, text = list_songs[6], font= label_font, text_color= "black")
def ls7():
    label_display7.place(x = 351, y = 45, anchor = ctk.CENTER)
    label_display1.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display2.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display4.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display5.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display6.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_display3.place(x = 1000, y = 45, anchor = ctk.CENTER)
    label_image1._text = list_songs[6]
    # label_image1.place(x = 351, y = 45, anchor = ctk.CENTER)
